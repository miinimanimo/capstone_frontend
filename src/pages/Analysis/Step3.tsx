...
interface Step3Props {
  ...
  setShowSuperpixel: (show: boolean) => void;
  selectedSeverity: string;
  setSelectedSeverity: (severity: string) => void;
  currentLesion: string | null;
  setCurrentLesion: (lesion: string | null) => void;
  superpixelData: SuperpixelData | null;
  setSuperpixelData: (data: SuperpixelData | null) => void;
  selectedPixels: {[key: string]: number[]};
  setSelectedPixels: (pixels: {[key: string]: number[]}) => void;
  selectedSuperpixels: {[key: string]: number[]};
  setSelectedSuperpixels: (superpixels: {[key: string]: number[]}) => void;
  imageRef: React.RefObject<HTMLDivElement>;
  canvasRef: React.RefObject<HTMLCanvasElement>;
  handleSizeChange: (increment: boolean) => void;
        ...
        <div className="final-diagnosis-left">
          <div className="toggle-controls">
            ...
            <div className="size-control">
              ...
              <span className="size-value">{imageSize.width}%</span>
          ...
          >
            <img
              ...
              style={{
                transform: `scale(${Math.round(imageSize.width) / 100}) translate(${imagePosition.x}px, ${imagePosition.y}px)`,
            ...
            <canvas
              ...
              style={{
                ...
                left: '50%',
                pointerEvents: 'auto',
                transform: `translate(-50%, -50%) scale(${imageSize.width / 100}) translate(${imagePosition.x}px, ${imagePosition.y}px)`,
          ...
          <div className="severity-confirmation">
            ...
            <div className="severity-options">
              <div className="severity-option">
                <div className="severity-label">중증도</div>
                <div className="severity-value">중증</div>
              </div>
              <div className="severity-option">
                <div className="severity-label">확인 여부</div>
                <div className="severity-value">확인</div>
              </div>
            </div>
          </div>
